...
public sealed class MouseLabelViewModel : BindableBase
{
    ...
    public MouseLabelViewModel(ISettingsService settings)
    {
        _settings = settings;
        RefreshFromSettings();
    }

    public void Update(LanguageInfo info) => Code = info.DisplayLabel;
